...
/////////////////////////////   
    ...
    /////////////////////////////
        ...
        function changementZone(player, zone){
            ...
            else if (player.y >= 312 && player.y <= 500 && player.x >= 3656 && player.x <= 3704){
                this.scene.start("BatimentBreche");
                console.log("changement");
                villeBreche = false;
                villeBreche_2 = true;
            ...
            else if (player.y >= 1770 && player.x >= 3432 && player.x <= 3512){
                this.scene.start("BatimentFin");
                console.log("changement");
                villeBreche = false;
                villeBreche_2 = false;
            ...
            else if (player.y >= 1792 && player.x >= 3576 && player.x <= 3808){
